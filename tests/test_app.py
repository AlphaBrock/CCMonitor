...
class TestCheckThresholdAlerts(unittest.TestCase):
    ...
    def setUp(self):
        self.app = _make_app()
        self._cmd_patch = patch('src.runtime.app.run_event_command')
...
class TestTimeAwareAlerts(unittest.TestCase):
    ...
    def setUp(self):
        self.app = _make_app()
        self._cmd_patch = patch('src.runtime.app.run_event_command')
        self._time_aware_patch = patch('src.runtime.app.ALERT_TIME_AWARE', True)
        self._below_patch = patch('src.runtime.app.ALERT_TIME_AWARE_BELOW', 100)
        self._cmd_patch.start()
    ...
    def test_alert_suppressed_when_usage_behind_time(self):
        ...
        with patch('src.runtime.app.elapsed_pct', return_value=90.0):
    ...
    def test_alert_shown_when_usage_ahead_of_time(self):
        ...
        with patch('src.runtime.app.elapsed_pct', return_value=50.0):
            self.app._check_threshold_alerts({'five_hour': {'utilization': 82, 'resets_at': '2025-01-15T14:30:00+00:00'}})
    ...
    def test_fallback_when_elapsed_pct_none(self):
        ...
        with patch('src.runtime.app.elapsed_pct', return_value=None):
            self.app._check_threshold_alerts({'five_hour': {'utilization': 82}})
    ...
    def test_disabled_when_false(self):
        ...
        self._time_aware_patch.stop()
        with patch('src.runtime.app.ALERT_TIME_AWARE', False):
            with patch('src.runtime.app.elapsed_pct', return_value=90.0):
                self.app._check_threshold_alerts({'five_hour': {'utilization': 82, 'resets_at': '2025-01-15T14:30:00+00:00'}})
        self._time_aware_patch.start()
    ...
    def test_usage_equal_to_time_suppressed(self):
        ...
        with patch('src.runtime.app.elapsed_pct', return_value=82.0):
            self.app._check_threshold_alerts({'five_hour': {'utilization': 82, 'resets_at': '2025-01-15T14:30:00+00:00'}})
    ...
    def test_threshold_at_or_above_below_cutoff_always_fires(self):
        ...
        self._below_patch.stop()
        with patch('src.runtime.app.ALERT_TIME_AWARE_BELOW', 90):
            # Thresholds are [80, 95]. Usage crosses 95 which is >= 90 cutoff.
            with patch('src.runtime.app.elapsed_pct', return_value=98.0):
    ...
    def test_below_cutoff_exact_boundary_fires(self):
        ...
        self._below_patch.stop()
        with patch('src.runtime.app.ALERT_TIME_AWARE_BELOW', 80):
            with patch('src.runtime.app.elapsed_pct', return_value=90.0):
                self.app._check_threshold_alerts({'five_hour': {'utilization': 82, 'resets_at': '2025-01-15T14:30:00+00:00'}})
        self._below_patch.start()
...
class TestExtraUsageAlerts(unittest.TestCase):
    ...
    def test_notification_includes_credit_amounts(self):
        ...
        with patch('src.runtime.app.format_credits', side_effect=lambda c: f'${c / 100:.2f}'):
            self.app._check_extra_usage_alerts(self._extra_data(used=820, limit=1000))
    ...
    def test_no_time_aware_logic(self):
        ...
        with patch('src.runtime.app.ALERT_TIME_AWARE', True):
            self.app._check_extra_usage_alerts(self._extra_data(used=820, limit=1000))
...
class TestSecondsUntilNextReset(unittest.TestCase):
    ...
    @patch('src.runtime.app.datetime')
...
class TestMenuActions(unittest.TestCase):
    ...
    def test_on_show_popup_reuses_single_popup_instance(self):
        """on_show_popup() 复用单例窗口并触发显示。"""
        popup = MagicMock()
        with patch.object(self.app, '_ensure_popup', return_value=popup) as mock_ensure:
    ...
    def test_on_quit_stops_running(self):
        ...
        self.app.popup = MagicMock()
        self.app.on_quit()
        self.assertFalse(self.app.running)
        self.app.popup.close.assert_called_once_with()
...
class TestIsUserAway(unittest.TestCase):
    ...
    @patch('src.runtime.app.is_workstation_locked', return_value=False)
    @patch('src.runtime.app.get_idle_seconds', return_value=400.0)
    @patch('src.runtime.app.IDLE_PAUSE', 300)
    def test_idle_over_threshold_is_away(self, _idle, _locked):
        """User is away when idle time exceeds IDLE_PAUSE."""
        self.assertTrue(self.app._is_user_away())

    @patch('src.runtime.app.is_workstation_locked', return_value=False)
    @patch('src.runtime.app.get_idle_seconds', return_value=200.0)
    @patch('src.runtime.app.IDLE_PAUSE', 300)
    ...
    @patch('src.runtime.app.is_workstation_locked', return_value=False)
    @patch('src.runtime.app.get_idle_seconds', return_value=300.0)
    @patch('src.runtime.app.IDLE_PAUSE', 300)
    ...
    @patch('src.runtime.app.is_workstation_locked', return_value=False)
    @patch('src.runtime.app.get_idle_seconds', return_value=9999.0)
    @patch('src.runtime.app.IDLE_PAUSE', 0)
    ...
    @patch('src.runtime.app.is_workstation_locked', return_value=False)
    @patch('src.runtime.app.get_idle_seconds', return_value=0.0)
    @patch('src.runtime.app.IDLE_PAUSE', 300)
...
class TestWaitForActivity(unittest.TestCase):
    ...
    @patch('src.runtime.app.time.sleep')
    ...
    @patch('src.runtime.app.time.sleep')
    @patch('src.runtime.app.time.time')
...
class TestThresholdCommand(unittest.TestCase):
    ...
    @patch('src.runtime.app.ON_THRESHOLD_COMMAND', ['notify.bat'])
    @patch('src.runtime.app.ALERT_TIME_AWARE', False)
    @patch('src.runtime.app.run_event_command')
    ...
    @patch('src.runtime.app.ON_THRESHOLD_COMMAND', [])
    @patch('src.runtime.app.run_event_command')
    ...
    @patch('src.runtime.app.ON_THRESHOLD_COMMAND', ['notify.bat'])
    @patch('src.runtime.app.ALERT_TIME_AWARE', True)
    @patch('src.runtime.app.ALERT_TIME_AWARE_BELOW', 90)
    @patch('src.runtime.app.run_event_command')
...
class TestPollLoopIdleInterruption(unittest.TestCase):
    ...
    @patch('src.runtime.app.ON_RESET_COMMAND', ['echo reset'])
    @patch('src.runtime.app.POLL_INTERVAL', 180)
    @patch('src.runtime.app.time.sleep')
    @patch('src.runtime.app.time.time')
